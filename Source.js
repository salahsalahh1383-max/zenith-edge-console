...
async function getCachedIps() {
	...
	try {
		...
		const addedIps = [
			"103.31.4.80", "103.31.4.235", "103.31.4.89", "103.31.4.218", "103.31.4.242",
			"103.31.4.124", "103.31.4.184", "103.31.4.221", "103.31.4.180", "103.31.4.54",
			"103.31.4.149", "103.31.4.29", "103.31.4.26", "103.31.4.52", "103.31.4.47",
			"103.31.4.190", "103.31.4.51", "103.31.4.163", "103.31.4.187", "103.31.4.102"
		];
		const lines = [...text.split("\n"), ...addedIps].map((l) => l.trim()).filter((l) => l.length > 0 && !l.includes("#") && !l.startsWith("[source"));
		if (lines.length > 0) {
